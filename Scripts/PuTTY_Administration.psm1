...
Export-ModuleMember -Function 'Copy-PuTTYsessionColour', 'Connect-PuTTYSession', 'Export-PuTTYSessions', 'Import-PuTTYSessions', 'New-PuttySessionsRegistryFile', 'Set-PuTTYTheme', 'Show-PuTTYSessions' -Verbose
