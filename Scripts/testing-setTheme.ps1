function Set-PuTTYTheme #Complete
{
  <#
      .SYNOPSIS
  ...
  function Script:Show_AsciiMenu 
  {
    <#
        .SYNOPSIS
        A quick menu using ASCII characters
    ...
    Begin {
      ...
      function Write-MenuTitle
      {
        ...
        {
          $TextPadding = Script:Get_Padding -Multiplier ($TitlePaddingCount + 1)
        }
      ...
      function Write-MenuItems
      {
        ...
        foreach($menuItem in $MenuItems)
        {
          ...
          $ItemPadding = Get_Padding -Multiplier $ItemPaddingCount
    ...
    Process {
      ...
      $TextPadding = Script:Get_Padding -Multiplier $TitlePaddingCount
